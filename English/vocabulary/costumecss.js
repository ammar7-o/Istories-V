...
function loadCustomCSS() {
    const savedCSS = localStorage.getItem('customCSSVo') || '';
...
function saveCustomCSS() {
    const css = customCSSInput.value.trim();
    localStorage.setItem('customCSSVo', css);
    applyCustomCSS(css);
...
function clearCustomCSS() {
    if (confirm('Are you sure you want to clear all custom CSS?')) {
        ...
        localStorage.removeItem('customCSSVo');
...
function performFullReset() {
    ...
    localStorage.setItem('customCSSVo', defaultSettings.customCSS);
