...
function loadCustomCSS() {
    const savedCSS = localStorage.getItem('customCSSquiz') || '';
...
function saveCustomCSS() {
    const css = customCSSInput.value.trim();
    localStorage.setItem('customCSSquiz', css);
    applyCustomCSS(css);
...
function clearCustomCSS() {
    if (confirm('Are you sure you want to clear all custom CSS?')) {
        ...
        localStorage.removeItem('customCSSquiz');
...
function performFullReset() {
    ...
    localStorage.setItem('customCSSquiz', defaultSettings.customCSS);
