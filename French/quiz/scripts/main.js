...
// Remove from sentence function - UPDATED FOR MOBILE
function removeFromSentence(questionIndex, word) {
    ...
    // Add CSS for cursor
    scrambledWord.style.cursor = 'grab';
    scrambledWord.style.userSelect = 'none';
    scrambledWord.style.webkitUserSelect = 'none';

    scrambledContainer.appendChild(scrambledWord);

    // Add events - UPDATED FOR TOUCH
    ...
    // Add click event for easier removal on mobile
    scrambledWord.addEventListener('click', function (e) {
    ...
    if (sentenceContainer.children.length === 0) {
        ...
        placeholder.style.cssText = 'width: 100%; text-align: center; color: var(--text-muted); padding: 20px;';
        placeholder.textContent = isMobileDevice() ? 'Tap words above to start' : 'Drop words here to build your sentence';
